...
public class EmailBaseLogic {
    ...
    /**
     * 邮箱发送服务器 发送邮件服务器： smtp.qq.com，使用SSL，端口号465或587
     */
     ...
     * 邮箱账号
     */
    private String user = "395022114@qq.com";
    /**
     * 邮箱密码
     */
    private String pass = "syezazrbrugnbged";
    /**
     * 目标邮箱
     */
    private String to;
...
//            pro.setProperty("mail.smtp.socketFactory.port", String.valueOf(port));
            ...
            pro.setProperty("mail.smtp.host", this.host);
...
//			pro.setProperty("mail.smtp.socketFactory.port", String.valueOf(port));
            ...
            String mailTemplateFooter = "</p><p style='text-align:right;padding:0 22px 0 0;margin:20px 0 0 0;'>XXX</p></div><div style='background:#efefef;color:#999999;text-align:center;padding: 10px 0;'><p>此为系统邮件，请勿回复</p><p>本页面内容最终解释权归XXX拥有</p><p>网址:<a href='https://www.baidu.com/' style='color:#01abff' target='_blank'>www.baidu.com</a>&nbsp;&nbsp;&nbsp;客服电话:400-xxx-xxxx</p></div></div>";
            ...
            // cid:image, cid后面的key: image, 固定写法
